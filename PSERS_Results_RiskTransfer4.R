...
results_all %>% filter(runname == "RS1_SR1EL1", sim == 0)                                    %>% select(runname,Tier, year, FR_MA, AL, PR, NC_PR, B,SC, EEC_PR, ERC, ERC.final_PR)
results_all %>% filter(runname == "RS1_SR1EL1_sep_R725.d725", sim == 0, Tier == "sumTiers.New")  %>% select(runname,Tier, year, FR_MA, AL, PR, NC_PR, B,SC, EEC_PR, ERC, ERC.final_PR)



results_all %>% filter(runname == "SR1EL1.Reform_R725.d725.DC4", sim == 0)                                    %>% select(runname,Tier, year, FR_MA, AL, PR, NC_PR, B,SC, EEC_PR, ERC, ERC.final_PR)
results_all %>% filter(runname == "SR1EL1.Reform_sep_R725.d725.DC4", sim == 0, Tier == "sumTiers")  %>% select(runname,Tier, year, FR_MA, AL, PR, NC_PR, B,SC, EEC_PR, ERC, ERC.final_PR)
...
riskTransfer.IFO.DC4.fy %>% filter(str_detect(var, "CF"))

riskTransfer.IFO.DC4.p1 %>% filter(str_detect(var, "PV725"))
riskTransfer.IFO.DC4.p2 %>% filter(str_detect(var, "PV725"))
riskTransfer.IFO.DC4.p3 %>% filter(str_detect(var, "PV725"))
riskTransfer.IFO.DC4.fy %>% filter(str_detect(var, "PV725"))
