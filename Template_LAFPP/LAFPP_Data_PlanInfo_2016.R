# This script imports plan information from PlanInfo-LAFPP_2016.xlsx
...
file_planInfo <- "Data_inputs/LAFPP_PlanInfo_2016.xlsx"
...
save(mortality_LAFPP, retRates, termRates, disbRates, bfactor, salgrowth, tier.param, init_amort_raw, init_unrecReturns.unadj,
     file  = "Data_inputs/LAFPP_PlanInfo_2016.RData")
